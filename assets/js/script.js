// seleção da seção about
const about = document.querySelector('#about');

// seletor da seção projects
...
async function getAboutGithub() {
    try {
        const resposta = await fetch('https://api.github.com/users/bruzuppini');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                ...
                <p>
                    ...
                    Com habilidades em HTML, CSS, JavaScript, Node.js, Nest e diversas tecnologias de desenvolvimento, 
                    estou sempre em busca de novos desafios para aprimorar minhas habilidades e contribuir para projetos inovadores.
                </p>
                <p>
                    Minha jornada na programação começou há pouco tempo, e tenho me dedicado a aprender e crescer como desenvolvedora. 
                    Adoro trabalhar em equipe, compartilhar conhecimentos e encontrar soluções criativas para problemas complexos.
                </p>

                <div class="about-buttons-data">
                    <div class="buttons-container">
                    <a href="${perfil.html_url}" target="_blank" class="botao">GitHub</a>
                    <a href="https://drive.google.com/file/d/1hIMha4d0JOuW6NHmgeVinAsaWtSIy2Q8/view" target="_blank" class="botao-outline">Currículo</a>
                </div>
...
async function getProjectsGithub() {
    console.log('iniciou');
    try {
        const resposta = await fetch('https://api.github.com/users/bruzuppini/repos?sort=updated&per_page=6')
        const repositorios = await resposta.json();

        swiperWrapper.innerHTML = '';

        // objeto contendo a lista de linguagens
        const linguagens = {    
        ...
        repositorios.forEach(repositorio => {
            ...
            console.log('criando', repositorio.name);
         ...
         <div class="swiper-slide">
            <article class="project-card">
                <div class="project-image">
                    <img src="${urlLogo}"
                        alt="Ícone ${linguagem}"
                        onerror="this.onerror=null; this.src='./assets/icon/languages/github.svg';">
                </div>
